 ...
 *         &lt;element name="Nodo" type="{urn:sap-com:document:sap:rfc:functions}char3" minOccurs="0"/&gt;
...
@XmlType(name = "",
         propOrder =
         { "comuna", "contratocliente", "fechainstalacion", "iCabCon", "idcentroaliado", "idordenlegado", "nodo",
           "numeroserie", "pais", "razonsocial", "region", "rutcliente", "rutsociedad", "sku", "tipocliente"
    })
@XmlRootElement(name = "ZwsMsMontSur")
public class ZwsMsMontSur {
