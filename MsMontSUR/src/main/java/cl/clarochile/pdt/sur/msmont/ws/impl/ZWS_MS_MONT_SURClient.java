...
public class ZWS_MS_MONT_SURClient {
    public static void main(String[] args) {
        ZWSMSMONTSUR_Service zWSMSMONTSUR_Service = new ZWSMSMONTSUR_Service();
        ZWSMSMONTSUR zWSMSMONTSUR = zWSMSMONTSUR_Service.getZWSMSMONTSUR();

        // Configure credential providers
        Map<String, Object> requestContext = ((BindingProvider) zWSMSMONTSUR).getRequestContext();
        ...
        ZesCabRes res = zWSMSMONTSUR.zwsMsMontSur("comuna", "atocliente", "fechainstalacion", new ZesCabCon(), "idcentroaliado", "idordenlegado", "nodo", "numeroserie", "pais", "razonsocial", "region", "rutcliente", "rutsociedad", "sku", "tipocliente");
